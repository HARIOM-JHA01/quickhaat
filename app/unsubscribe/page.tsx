      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            You've been removed from the selected email lists. You can update
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-sm p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            We're sorry to see you go! Choose which emails you'd like to
            unsubscribe from:
          </p>
          ...
          <div className="flex flex-col gap-3 pt-4">
            <Button
              onClick={() => {
                ...
                // For simplicity, unsubscribe from all selected at once
                handleUnsubscribe(
